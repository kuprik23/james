...
import { Notification, NotificationType, LicenseTier } from './types';
...
class NotificationManager {
   ...
   * Show upgrade prompt
   */
  upgradePrompt(feature: string, currentTier: LicenseTier, requiredTier: LicenseTier): void {
    const message = `
...
`;
   ...
   */
  scanLimitReached(tier: LicenseTier, limit: number): void {
    const message = `
